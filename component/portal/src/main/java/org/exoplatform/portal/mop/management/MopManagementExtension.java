...
public class MopManagementExtension implements ManagementExtension
{
   ...
   private void siteLayoutManagementRegistration(ManagedResource.Registration sites)
   {
      ...
      siteLayout.registerOperationHandler(OperationNames.READ_CONFIG, new SiteLayoutReadConfig(), description("Reads site layout data for a specific site as configuration xml."));
   ...
   private void pageManagementRegistration(ManagedResource.Registration sites)
   {
      ...
      pages.registerOperationHandler(OperationNames.READ_CONFIG, new PageReadConfig(), description("Reads pages as configuration xml at a specified address."), true);
   ...
   private void navigationManagementRegistration(ManagedResource.Registration sites)
   {
      ...
      navigation.registerOperationHandler(OperationNames.READ_CONFIG, new NavigationReadConfig(), description("Reads navigation as configuration xml at a specified address."), true);
