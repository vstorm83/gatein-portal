...
public class TestResourceBundleService extends AbstractResourceBundleTest {
    ...
    private static final String PROPERTIES = "language=en\nproperty=property";

    private static final String PROPERTIES_FR = "language=fr";

    private static final String PROPERTIES_FR_UPDATE = "language=fr\nproperty=fr-property";
