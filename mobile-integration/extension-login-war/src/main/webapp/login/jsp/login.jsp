...
<%@ page import="org.exoplatform.web.login.ErrorData"%>
...
<%
  ...
  String errorParam = (String)request.getParameter(org.exoplatform.web.login.ErrorData.ERROR_PARAM);
  ErrorData errorData = null;
  if (errorParam != null) {
      errorData = ErrorData.parse(errorParam);
  }
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="error-pane"><p>
        <%    if (errorData != null) {
						if (org.exoplatform.web.login.ErrorData.DISABLED_USER_ERROR == errorData.getCode()) {
        %>
