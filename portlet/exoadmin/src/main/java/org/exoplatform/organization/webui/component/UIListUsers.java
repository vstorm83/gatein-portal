...
@ComponentConfig(lifecycle = UIContainerLifecycle.class, events = {
        ...
        @EventConfig(listeners = UIListUsers.UserStatusFilterChangeActionListener.class),
...
public class UIListUsers extends UISearch {
    ...
    public UIListUsers() throws Exception {
        ...
        if(showDisableUserFilterCheckbox) {
            ...
            selectBox.setOnChange("UserStatusFilterChange");
    ...
    public static class UserStatusFilterChangeActionListener extends EventListener<UIListUsers> {
        @Override
        public void execute(Event<UIListUsers> event) throws Exception {
            UIListUsers listUsers = event.getSource();
            UIFormSelectBox selectBox = (UIFormSelectBox) listUsers.getUISearchForm().getQuickSearchInputSet()
